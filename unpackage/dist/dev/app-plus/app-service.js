...
(function(vue) {
  ...
  const PagesImSearch = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$9], ["__scopeId", "data-v-739b0953"], ["__file", "D:/H/Desktop/Violet/uniapp/pages/im/search.vue"]]);
  const _sfc_main$8 = {
    data() {
      return {};
    },
  ...
  (function(module) {
    (function(global2) {
      if (module.exports && !global2["encoding-indexes"]) {
        global2["encoding-indexes"] = requireEncodingIndexes()["encoding-indexes"];
      }
      ...
      function TextEncoder(label, options) {
        ...
        if (Boolean(options["NONSTANDARD_allowLegacyEncoding"])) {
          ...
          if (label !== void 0 && "console" in global2) {
            formatAppLog("warn", "at node_modules/text-encoding/lib/encoding.js:1245", "TextEncoder constructor called with encoding label, which is ignored.");
          }
        }
        if (!Object.defineProperty)
  ...
  class Socket {
    constructor() {
      ...
      __publicField(this, "socketWriter", null);
      __publicField(this, "socketReader", null);
      __publicField(this, "listenIntervalId", null);
      __publicField(this, "heartIntervalId", null);
    }
    start() {
      try {
        ...
        formatAppLog("log", "at utils/netty.js:27", "连接服务器中...");
        this.socket = new JavaSocket("127.0.0.1", 3001);
        this.socket.setSoTimeout(1e3);
        ...
        formatAppLog("error", "at utils/netty.js:41", "连接出错:", e);
      }
    }
    listenToServer() {
      ...
      this.listenIntervalId = setInterval(() => {
        try {
          if (this.socketReader && this.socketReader.available()) {
            ...
            if (receiveHeadSize < 8) {
              ...
              if (receiveDataSize === dataSize) {
                ...
                const data2 = decoder.decode(dataByte);
                receiveHeadSize = 0;
                receiveDataSize = 0;
              }
            }
          ...
          formatAppLog("error", "at utils/netty.js:74", "读取消息出错:", e);
          this.close();
        }
      }, 1);
    }
    heartBeat() {
      this.heartIntervalId = setInterval(() => {
        if (this.socketWriter) {
          ...
          formatAppLog("log", "at utils/netty.js:86", "未建立连接，无法发送消息");
        }
      }, 5e3);
    }
    close() {
      if (this.socket) {
        try {
          ...
          formatAppLog("error", "at utils/netty.js:103", "关闭连接出错:", e);
        }
      }
    }
  }
  ...
  const getUserProfile = async (userId, needFollowInfo) => {
    const token = getApp().globalData.token;
    const data2 = {
      user_id: userId,
    ...
    methods: {
      ...
      async toggleFollow() {
        ...
        if (this.isFollowed) {
          ...
          if (res.statusCode === 200) {
            formatAppLog("log", "at pages/user/user_profile.vue:96", res);
          ...
          if (res.statusCode === 200) {
            formatAppLog("log", "at pages/user/user_profile.vue:115", res);
  ...
  function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", { class: "user-list-container" }, [
      $data.userList.length > 0 ? (vue.openBlock(), vue.createElementBlock("view", {
        key: 0,
        class: "user-list"
      }, [
  ...
  const PagesUserFriendList = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$5], ["__scopeId", "data-v-45095eb2"], ["__file", "D:/H/Desktop/Violet/uniapp/pages/user/friend_list.vue"]]);
  const _sfc_main$4 = {
    data() {
      return {
        userId: null,
  ...
  const PagesUserFollowingList = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["__scopeId", "data-v-5d140a69"], ["__file", "D:/H/Desktop/Violet/uniapp/pages/user/following_list.vue"]]);
  const _sfc_main$3 = {
    data() {
      return {
        userId: null,
  ...
  const PagesUserFollowerList = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["__scopeId", "data-v-1ecc1525"], ["__file", "D:/H/Desktop/Violet/uniapp/pages/user/follower_list.vue"]]);
  const getByInit = () => {
    const {
      token,
      userId
        ...
        if (res.statusCode === 200) {
          ...
          if (res.code === 1e3) {
            ...
            DB.createTable(res.data.user_id).catch((err) => {
              formatAppLog("error", "at pages/user/login.vue:55", "createTable err", err);
            });
            initAuth();
            uni.showToast({
              title: "登录成功",
  ...
  const PagesUserLogin = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["__scopeId", "data-v-6163e5ce"], ["__file", "D:/H/Desktop/Violet/uniapp/pages/user/login.vue"]]);
  const _sfc_main$1 = {
    data() {
      return {
        username: "",
  ...
  const PagesUserRegister = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1], ["__scopeId", "data-v-fd534bf9"], ["__file", "D:/H/Desktop/Violet/uniapp/pages/user/register.vue"]]);
